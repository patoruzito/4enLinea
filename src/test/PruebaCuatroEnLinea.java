...
public class PruebaCuatroEnLinea {
	...
	public void siCantidadDeFilasEsCeroSeProduceError(){
		juego = new CuatroEnLinea(0,6,"Ariana","Martin");
	}
	
	@Test (expected=Error.class)
	public void siCantidadDeFilasEsMenorACeroSeProduceError(){
		juego = new CuatroEnLinea(-8,6,"Lara","Pablo");
	}
	
	@Test (expected=Error.class)
	public void siCantidadDeColumnasEsMenorACeroSeProduceError(){
		juego = new CuatroEnLinea(8,-8,"Ariana","Martin");
	}
	
	@Test (expected=Error.class)
	public void siLosJugadoresTienenElMismoNombreSeProduceError(){
		juego = new CuatroEnLinea(6,6,"Ariana","Ariana");
	}
	
	@Test (expected=Error.class)
	public void siSeQuiereObtenerLoQueHayEnUnaFilaNegativaDaError(){
		juego = new CuatroEnLinea(7,7,"Tito","Pepa");
		juego.obtenerCasillero(-7, 7);
	}	
	
	@Test (expected=Error.class)
	public void siSeQuiereObtenerLoQueHayEnUnaColumnaNegativaDaError(){
		juego = new CuatroEnLinea(7,-7,"Tito","Pepa");
		juego.obtenerCasillero(7, -7);
	}	
	
	@Test (expected=Error.class)
	public void siSeQuiereObtenerLoQueHayEnUnaFilaFueraDeRangoDaError(){
		juego = new CuatroEnLinea(6,6,"Tito","Pepa");
		juego.obtenerCasillero(8,6);
	}	
	
	@Test (expected=Error.class)
	public void siSeQuiereObtenerLoQueHayEnUnaColumnaFueraDeRangoDaError(){
		juego = new CuatroEnLinea(6,6,"A","B");
		juego.obtenerCasillero(6,8);
	}	
    ...
    @Test (expected = Error.class)
    public void  soltarFichaEnColumnaCeroDaError(){
    	juego = new CuatroEnLinea(8, 6, "Agus", "Leo");
    	
    	juego.soltarFichaEnColumna(0);
    }
   
 //   @Test (expected = Error.class)
 //   public void soltarFichaSiElJuegoTerminoDaError(){
//    	juego = new CuatroEnLinea(7,7,"Alpha","Beta");
//    	juego.cantidadFichas = 0;
