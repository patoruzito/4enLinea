...
public class PruebaReglasCuatroEnLinea {
    ...
    @Test
   	public void gananRojasConDiagonalDesdeColumna3Fila5HastaColumna7Fila4() {
   		
   		juego = new CuatroEnLinea(7, 9, "Cata", "Gonza");
   		fueronSoltadasFichasEnColumnas(1,2,3,4,4,3,2,1,4,3,2,1,1,2,3,4,4,5,6,5,5,5,6,6);

   		juego.soltarFichaEnColumna(6);
   		
   		asertarQueElGanadorEs ("Cata") ;
       ...
       @Test	
   	public void gananRojasConDiagonalDesdeColumna1Fila8HastaColumna4Fila5() {
   		
   		juego = new CuatroEnLinea(9, 6, "Romi", "Alan");
   		fueronSoltadasFichasEnColumnas(3,4,2,1,2,4,4,1,3,2,3,2,4,3,3);

   		juego.soltarFichaEnColumna(4);
   		
   		asertarQueElGanadorEs("Alan");
   	}
